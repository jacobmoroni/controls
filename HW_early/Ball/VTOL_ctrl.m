function output=VTOL_ctrl(in,P)
    ...
    theta_r = PID_z(z_r,z,flag,P.kp_z,P.ki_z,P.Ts,P.sigma);
    
    tau = PID_th(theta_r,theta,flag,P.kp_th,P.kd_th,...
...
function u = PID_h(h_r,h,flag,kp,ki,kd,Ts,sigma)
    ...
    u = kp*error + ki*integrator -kd*hdot;
