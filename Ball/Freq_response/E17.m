...
% As seen from Figure 1 the bandwidth of the inner loop is approximately
% 44 rad/sec, which is 1.7 times larger than the cross over frequency of 26 rad/sec.
% The larger bandwidth is due to the small phase margin of PM = 20 degrees.
% Similarly, Figure 1 indicates that the bandwidth of the outer loop
% is 4.2 rad/sec, which is 1.5 times larger than the cross over frequency of
% 2.8 rad/sec. The higher phase margin of PM = 58 degrees increases the
% damping in the system and lowers the bandwidth slightly. The closed-loop
% magnitude for the inner loop is approximately one at frequencies up to five
% times the bandwidth of the inner loop. Furthermore, the phase of the closed
% inner loop system is near zero up to frequencies above the crossover frequency
% of the outer loop. This bandwidth separation ensures that the influence of
% the inner loop on the outer loop design and operation is minimal within the
