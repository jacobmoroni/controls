...
%crossover freq. of 1.3 due to the nearly ideal phase margin of PM = 59.5 degrees.
%The small deviation from 0 dB in the closed loop response between
%0.3 - 1.2 rad/sec is due to the small open loop gain over those frequencies
