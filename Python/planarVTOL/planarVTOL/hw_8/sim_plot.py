...
class plotGenerator:
    ...
    def __init__(self):
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0,0],1,'t(s)','m','h_r/h'))
        self.handle.append(myPlot(self.ax[0,1],1,'t(s)','m','z_r/z'))
        self.handle.append(myPlot(self.ax[1,0],180.0/np.pi,'t(s)','deg','/th'))
        self.handle.append(myPlot(self.ax[1,1],1,'t(s)','N','F/tau'))
        ####################################################################
